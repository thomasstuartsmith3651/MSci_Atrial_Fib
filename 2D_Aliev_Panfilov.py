...
L_x = 0.006 #Range of the domain according to x [m]
dx = 0.00006 #Infinitesimal distance in the x direction
...
L_y = 0.006 #Range of the domain according to y [m]
dy = 0.00006 #Infinitesimal distance in the x direction
...
L_t = 0.005 #Duration of simulation [s]
